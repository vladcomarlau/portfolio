...
export default function ContactBadges(props: any) {
    return(
        <>
            <span className="px-1">
                <div className="inline-block">
                    <motion.a
                        ...
                        <span className="badge badge-xl shadow-lg rounded-full customDarkGlass text-sm my-1 ml-1">
                            ...
                            <a className='text-base-950' >vladcom95@gmail.com</a>
                        </span>
                    </motion.a>
                    ...
                    <motion.a
                        ...
                        <span className="badge badge-xl shadow-lg rounded-full customDarkGlass text-sm my-1 ml-1">
                            ...
                            <a className='text-base-950'>0752 230 503</a>
                        </span>
                    </motion.a>
                </div>
                <span className="inline-block -mr-2 my-1 ml-1">
                    <motion.a
                        initial={{scale: 0.2, opacity: 0 }}
                        animate={{scale: 1, opacity: 1 }}
                    ...
                    <motion.a
                        ...
                        target="_">
                        <span className="badge badge-xl customDarkGlass shadow-xl mr-1">
                            <a>
